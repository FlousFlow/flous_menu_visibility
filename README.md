...
The module lives in the `flous_menu_visibility/` folder.

```bash
./odoo-bin -c odoo.conf -d DB_NAME -i flous_menu_visibility --stop-after-init
```

**License:** LGPL-3 — © 2026 Flous Flow.
